...
public class Geo implements Serializable {
	   ...
	   * @param lat latitude in decimal degrees.
	   * @param lon longitude in decimal degrees.
	   * @param nodeId node identifier in integer.
	   */
	  public Geo(double lat, double lon, int nodeId) {
	      initialize(lat, lon);
	      this.nodeId = nodeId;
	  }
	      ...
	      for (int i = 1; i < pl; i++) {
	          ...
	          if (n0 == null || g0 == null) {
	              ...
	              if (handed > 0) { // left needs two points, right needs 1
	                  ...
	                  Geo ip = segmentsIntersect(r0, r1a, r1b, g2.add(n1));
	                  ...
	                  Geo ip = segmentsIntersect(l0, l1a, l1b, g2.subtract(n1));
	                  // if they intersect, take the intersection, else use the
	                  // points and punt
	                  if (ip != null) {
	                      right.add(ip);
